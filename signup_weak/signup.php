...
<body>
    <div id="container-register">
        ...
        <form method="POST" action="form_submit.php">
            ...
            <input type="submit" value="Register" style="border: 2px solid #DCDC00;" />
        </form>

        <div class="register">
            Do you already have an account?
            <a href="../login_weak/login.php"><button id="register-link" style="border: 2px solid #DCDC00;">Log In
                    here</button></a>
        </div>
    </div>
    <script>
